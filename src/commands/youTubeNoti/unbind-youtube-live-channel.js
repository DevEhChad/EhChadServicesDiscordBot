...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (!doc || !doc.channelId) {
      return interaction.reply({ content: 'No YouTube live notification channel is currently set for this server.', ephemeral: true });
    }

    doc.channelId = null;
    await doc.save();
    return interaction.reply({ content: '✅ Removed the YouTube live notification channel. Use `/bind-youtube-live-channel` to set a new one.', ephemeral: true });
  },
};
